...
#include "easynav_navmap_common/costmap_2d.hpp"
...
TEST_F(AMCLLocalizerTest, BasicDynamicUpdate)
{
  ...
  auto static_map = std::make_shared<::navmap::NavMap>();
  ...
  auto map_ptr = std::dynamic_pointer_cast<::navmap::NavMap>(manager->get_static_map());
...
TEST_F(AMCLLocalizerTest, IncomingOccupancyGridUpdatesMaps)
{
  ...
  auto static_map = std::dynamic_pointer_cast<::navmap::NavMap>(manager->get_static_map());
