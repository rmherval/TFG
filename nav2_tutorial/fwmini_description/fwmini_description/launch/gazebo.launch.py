...
def generate_launch_description():
    ...
    if "GZ_SIM_RESOURCE_PATH" in os.environ:
        ...
        print("GAZEBO" + str(gz_sim_resource_path))
    ...
    fly_world_path = '/home/ubuntu/ros_ws/src/fwmini_description' + '/worlds/' + world + '.sdf'
    ...
    print("launch airguments " + str(launch_arguments))
    # Gazebo Sim.
